...
public class UserStore {
        ...
        try (PreparedStatement st = connection.prepareStatement(settings.getValue("SQL_SELECT_USER"))) {
            ...
            try (ResultSet rs = st.executeQuery()) {
                if (rs.next()) {
                    ...
                    result = new User(name, login, password, email, role, country, city);
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public int add(User user) {
        ...
        final String[] args = {user.getName(), user.getLogin(), user.getPassword(), user.getEmail(), user.getRole().getDescription(), user.getCountry(), user.getCity(), user.getName()};
    ...
    public int edit(User user) {
        ...
        final String[] args = {user.getLogin(), user.getPassword(), user.getEmail(), user.getRole().getDescription(), user.getCountry(), user.getCity(), user.getName()};
        return this.editUser(prepareSQL, args);
    }
    ...
    public List<String> getCountries() {
        ...
        try (Statement st = connection.createStatement();
             ResultSet rs = st.executeQuery(settings.getValue("SQL_SELECT_COUNTRIES"))) {
    ...
    public List<String> getCitiesByCountry(String country) {
        ...
        try (PreparedStatement st = connection.prepareStatement(settings.getValue("SQL_SELECT_CITY_FROM_COUNTRY"))) {
    ...
    public int addCountry(String country) {
        return this.editUser(settings.getValue("SQL_INSERT_COUNTRY"), new String[]{country, country});
    }
     ...
     * @return - number rows.
     */
    public int addCity(String country, String city) {
        return this.editUser(settings.getValue("SQL_INSERT_CITY"), new String[]{city, country, city});
    }
}
